...
namespace Azure.Identity
{
    ...
    public class InteractiveBrowserCredential : TokenCredential
    {
        ...
        {
            AuthenticationResult result = await Client.AcquireTokenInteractiveAsync(context.Scopes, Prompt.SelectAccount, context.ClaimsChallenge, async, cancellationToken).ConfigureAwait(false);

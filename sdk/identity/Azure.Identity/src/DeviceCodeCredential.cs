...
namespace Azure.Identity
{
    ...
    public class DeviceCodeCredential : TokenCredential
    {
        ...
        public DeviceCodeCredential(string clientId, Func<DeviceCode, Task> deviceCodeCallback, IdentityClientOptions options)
        {
            ...
            _pubApp = PublicClientApplicationBuilder.Create(_clientId).WithHttpClientFactory(new HttpPipelineClientFactory(pipeline)).WithRedirectUri("https://login.microsoftonline.com/common/oauth2/nativeclient").Build();
        }

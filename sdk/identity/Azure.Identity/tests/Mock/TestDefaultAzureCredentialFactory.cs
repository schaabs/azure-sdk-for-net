...
namespace Azure.Identity.Tests.Mock
{
    internal class TestDefaultAzureCredentialFactory : DefaultAzureCredentialFactory
    {
        ...
        public override TokenCredential CreateInteractiveBrowserCredential(string tenantId)
            => new InteractiveBrowserCredential(tenantId, Constants.DeveloperSignOnClientId, new InteractiveBrowserCredentialOptions { CacheProvider = DefaultTokenCacheProvider.WithUnencryptedFallback }, Pipeline);
